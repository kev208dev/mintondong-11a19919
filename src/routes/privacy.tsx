...
function PrivacyPage() {
  const sections: LegalSection[] = [
    ...
    },
    {
      ...
      content: (
        <p>
          서비스의 회원 인증, 데이터베이스, 파일 저장과 인프라 운영을 위해 Supabase 서비스를
          이용합니다. 결제 처리 과정에서는 계약·활성화된 결제대행사에 구매자 이름·연락처,
          상품·금액·주문 식별정보 등 결제에 필요한 정보가 전달될 수 있습니다. 현재 PortOne V2를 통한
          KG이니시스 연동 코드는 준비되어 있으나 실제 운영 제공자와 구체적인 위탁 범위·보유기간은
          계약 및 채널 활성화 확정 후 이 방침에 반영합니다. 저장소의 Toss 테스트 연동은 실거래용
          운영 결제 제공을 의미하지 않습니다.
        </p>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          계정에서 직접 처리할 수 없는 요청은 <Link to="/business-info">사업자 정보</Link>의
          고객센터로 접수할 수 있습니다. 법령상 제한 사유가 있는 경우 그 사유를 안내합니다.
        </p>
      ),
    },
    {
