...
- [x] Production DB에 계정 삭제 migration 적용 및 schema/권한 검증
- [ ] 실제 비소유자 계정 삭제 실기기 QA
- [x] 공개 계정 삭제 설명 route
- [x] 개인정보처리방침
- [x] 이용약관
- [x] 환불정책
...
- [x] iOS Simulator build 및 cold start/home/safe-area 확인
...
- [x] Apple 계정 삭제 token revoke server flow 구현
